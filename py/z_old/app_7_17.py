...
# Temp Test
# test_str = """Concerning these two candidates, I feel that the Donald Trump campaign has been an embarrassing, yet enlightening window into the American electorate."""
